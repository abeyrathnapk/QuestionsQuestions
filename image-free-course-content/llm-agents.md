...
A split screen shows a light-skinned man with short brown hair giving a presentation at a podium on the left, and a slide presentation on the right. The man is wearing a dark gray or brown sweater.  The slide's title is "Challenges with agents" in a sans-serif font and lists several bullet points, including "Getting them to use tools in appropriate scenarios," "Parsing LLM Output to tool invocation," and "Getting them to stay focused." The bottom right corner of the slide has small text that reads "Large Language Models Bootcamp." The background behind both sections is a dark teal-green with a subtle, abstract pattern resembling a network of connections. The overall color palette is dark and muted.]](https://youtu.be/DWUdGhRrv2c)
