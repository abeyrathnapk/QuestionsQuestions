...
A light-skinned man with short brown hair and a beard gives a peace sign with his right hand. He's wearing a black jacket and a dark shirt. He's positioned in front of a computer screen displaying a Vercel dashboard. The dashboard is dark-themed with white and light purple text.  The Vercel logo, a white triangle with the word "Vercel" in white text, is prominently featured both on the screen and overlaid on the man's jacket.  The dashboard shows recent activity, including updates to projects named "vercel-times" and "nextjs.org."  Menu options at the top include "Projects," "Integrations," "Activity," "Domains," "Usage," and "Settings."  There are also "Acme" and "Enterprise" options. The words "Git Provider," "Feedback," and "Blog" are visible in the top right corner.]](https://youtu.be/sPmat30SE4k)

[[Image description: Here's alt text describing the image:

A teal-colored background features a black triangle containing a white lightning bolt.  Overlaid on the triangle is the text "DEPLOY FAST" in bold, white, sans-serif font. The background also has semi-transparent binary code scattered across it.  In the foreground, a smiling, bald man with a beard points to the triangle with his index finger. He is wearing a dark gray crew-neck shirt. The overall impression is a promotional image for a fast deployment software or service.]](https://youtu.be/8R-cetf_sZ4)
