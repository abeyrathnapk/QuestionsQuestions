...
[[Image description: [Image description unavailable: No API key]]](https://youtu.be/X-DHaQLrBi8)

Watch this video to understand the basics of Bash and UNIX shell commands (75 min).

[[Image description: [Image description unavailable: No API key]]](https://youtu.be/oxuRxtrO2Ag)
