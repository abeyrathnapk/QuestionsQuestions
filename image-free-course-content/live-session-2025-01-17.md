...
A graphic announcing "WEEK 1 SESSION 2" in bold white sans-serif font against a dark-blue rectangular banner.  This banner overlays a peach-colored square filled with a dense collection of colorful, stylized icons representing various aspects of data analysis and design. The icons include charts, graphs, pencils, a target, a network diagram, and geometric shapes. The overall style is modern and abstract, using a vibrant color palette of blues, yellows, oranges, and greens. The image is likely a session identifier for an online course or workshop focused on data visualization or a related subject.]](https://youtu.be/hG5WqtbpfkI)
