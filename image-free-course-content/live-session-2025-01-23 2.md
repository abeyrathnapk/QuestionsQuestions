...
A graphic announcing "WEEK 2 SESSION 4" in large, bold, white sans-serif font against a dark blue rectangular banner.  The banner is positioned over a peach-colored square filled with a variety of small, colorful icons representing different aspects of data analysis and design.  These icons include charts, graphs, a target, pencils, a globe, and geometric shapes in shades of yellow, orange, red, blue, and green.  The overall style is modern and abstract.]](https://youtu.be/TxGY540ru3A)
