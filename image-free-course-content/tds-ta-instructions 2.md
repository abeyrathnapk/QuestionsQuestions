...
Additionally, we visit each of the evaluation links on <https: exam.sanand.workers.dev=""></https:>, [copy it as Markdown](https://tools.s-anand.net/page2md/), and add it to the content, called `ga1.md`, `ga2.md`, etc.
