...
[[Image description: [Image description unavailable: No API key]]](https://youtu.be/4ExQYRCwbzw)
...
1. When you visit <http: localhost:8000=""></http:> you'll be redirected to a Google login page.
