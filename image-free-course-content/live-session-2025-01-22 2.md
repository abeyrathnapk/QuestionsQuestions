...
"A graphic announcing 'Week 2 Session 3' in large, white, sans-serif font against a dark blue banner.  The banner overlays a peach-colored square filled with a collage of colorful, stylized icons representing data analysis, design, and technology.  These include charts, graphs, pencils, a target, and interconnected nodes. The overall style is flat design and geometric. The color palette consists of peach, dark blue, various shades of yellow, red, blue, and green."]](https://youtu.be/QnLi-C_LiXk)
