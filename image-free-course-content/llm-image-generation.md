...
"A dark background with a bright yellow and purple border displays the text 'Gemini API' in white sans-serif font, stacked above the words 'Native Image' in larger, bolder white sans-serif font. A purple line is underlined under the words 'Native Image'.  A small, light-blue, four-pointed star with a bright sparkle effect is positioned above 'Gemini API'. The overall style suggests a technological or software-related context."]](https://youtu.be/wgs4UYx6quY) ([How to use Latest Gemini 2.0 Native Image Generation with API?](https://www.youtube.com/watch?v=wgs4UYx6quY))
...
"A logo for 'gpt-image-1' on a black background.  The logo consists of the text 'gpt-image-1' in bold, white sans-serif font. To the left of the text is a stylized white geometric logo resembling a flower or abstract symbol with six interconnected petals. The entire logo is enclosed within a rectangular border that transitions from purple to blue at the top, fading to a lighter blue at the bottom."]](https://youtu.be/k-G71JZA75A)
