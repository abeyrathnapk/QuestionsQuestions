...
[[Image description: [Image description unavailable: No API key]]](https://youtu.be/Dj7X0bQRJSs)

### Tools in Data Science Orientation

[[Image description: [Image description unavailable: No API key]]](https://youtu.be/_c_aFQ0ObLo?t=4186)

### Tools in Data Science Live Sessions

[[Image description: [Image description unavailable: No API key]]](https://www.youtube.com/@se-lr5ff)

### Tools in Data Science Playlist

[[Image description: [Image description unavailable: No API key]]](https://www.youtube.com/playlist?list=PLZ2ps__7DhBZEOxUBCkv61WHOu8m7ObpE)
...
[[Image description: [Image description unavailable: No API key]]](https://youtu.be/IEusn9HB1sc)
...
[[Image description: [Image description unavailable: No API key]]](https://youtu.be/b6puvm-QEY0)
...
[[Image description: [Image description unavailable: No API key]]](https://youtu.be/OTRamjRb7P4)
...
[[Image description: [Image description unavailable: No API key]]](https://youtu.be/aedA2javxvE)
...
[[Image description: [Image description unavailable: No API key]]](https://youtu.be/XsOihX38Bg0)
...
[[Image description: [Image description unavailable: No API key]]](https://youtu.be/WMUt7NOJGbo)

- [Jupyter Notebook](https://colab.research.google.com/drive/1-gHL2lEEuKRFP40tkDMCNPron3F3p3iW?usp=sharing)

## Clustering with Python

[[Image description: [Image description unavailable: No API key]]](https://youtu.be/lcMWH67TiWE)
...
[[Image description: [Image description unavailable: No API key]]](https://youtu.be/A9WX7HaS1eU)
...
[[Image description: [Image description unavailable: No API key]]](https://youtu.be/wkbYLFEBCJg)
...
[[Image description: [Image description unavailable: No API key]]](https://youtu.be/z4MUpn4FRTw)
...
[[Image description: [Image description unavailable: No API key]]](https://youtu.be/59u3XMiSyro)
...
-[[Image description: [Image description unavailable: No API key]]](https://youtu.be/b_Qojb9gLzA)

## Comic narratives with Google Sheets &amp; Comicgen

[[Image description: [Image description unavailable: No API key]]](https://youtu.be/HZDqCQBpHGI)
...
[[Image description: [Image description unavailable: No API key]]](https://youtu.be/QjvyiyH4rr0)
...
[[Image description: [Image description unavailable: No API key]]](https://youtu.be/YSGZjCxhIkk)

## Tools to anonymize data

[[Image description: [Image description unavailable: No API key]]](https://youtu.be/N8I-sxmMfqQ)

- [List of Tools](https://aircloak.com/top-5-free-data-anonymization-tools/)

## Libraries to build web applications

[[Image description: [Image description unavailable: No API key]]](https://youtu.be/iT5sS1dWMcc)
...
[[Image description: [Image description unavailable: No API key]]](https://youtu.be/V5dl7zkKXC0)
...
[[Image description: [Image description unavailable: No API key]]](https://youtu.be/3OeMOb7gByE)
...
[[Image description: [Image description unavailable: No API key]]](https://youtu.be/GY5l_5RpVZM)
...
[[Image description: [Image description unavailable: No API key]]](https://youtu.be/u8PIxqsi1kk)
...
[[Image description: [Image description unavailable: No API key]]](https://youtu.be/HlsqT0r9wAM)
...
[[Image description: [Image description unavailable: No API key]]](https://youtu.be/NNiFxgANu8Y)
...
- What's the official data portal of Russia? (ANS: <https: ?language="en" data.gov.ru="">)
...
[[Image description: [Image description unavailable: No API key]]](https://youtu.be/DH0Q4LiSgkE)
...
- How many images (`[Image description: [Image]]` tags) does this [White House page snapshot](https://web.archive.org/web/20110101070603id_/https://www.whitehouse.gov/) have inside a link (`<a>` element)? (ANS: 15)
...
[[Image description: [Image description unavailable: No API key]]](https://youtu.be/eHmvCNhZiWg)
