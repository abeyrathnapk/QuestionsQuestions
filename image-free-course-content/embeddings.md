...
A YouTube thumbnail featuring a smiling man with short brown hair and a beard. He's wearing a plain white shirt. The background is predominantly pale pink with abstract shapes, overlaid with dark brown text reading "Text embeddings &amp; semantic search" in a large font, and "with Lewis" in a smaller font below. A small happy emoji with clasped hands is also visible.  Parts of a light teal and white interface are visible in the background suggesting code or data related to the main topic.]](https://youtu.be/OATCgQtNX2o)
